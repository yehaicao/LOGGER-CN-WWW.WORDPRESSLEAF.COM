<?php
/* Posts images */
add_action( 'widgets_init', 'widget_posts_images_widget' );
function widget_posts_images_widget() {
	register_widget( 'Widget_posts_images' );
}
class Widget_posts_images extends WP_Widget {

	function Widget_posts_images() {
		$widget_ops = array( 'classname' => 'posts_images-widget'  );
		$control_ops = array( 'id_base' => 'posts_images-widget' );
		parent::__construct( 'posts_images-widget','Logger - posts images', $widget_ops, $control_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		echo $before_widget;
			...
			<div class="widget_post_img">
				<?php Vpanel_posts_images($posts_per_page,$orderby,$post_or_portfolio,$display,$category,$categories,$category_portfolio,$categories_portfolio);?>
			</div>
	...
	function form( $instance ) {
		$defaults = array( 'title' => __('Recent','vbegy'),'orderby' => 'recent','posts_per_page' => '8','post_or_portfolio' => 'post' );
