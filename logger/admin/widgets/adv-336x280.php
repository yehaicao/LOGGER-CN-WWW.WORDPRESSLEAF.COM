<?php
/* Adv 336x280 */
add_action( 'widgets_init', 'widget_adv336x280_widget' );
function widget_adv336x280_widget() {
	register_widget( 'Widget_Adv336x280' );
}
class Widget_Adv336x280 extends WP_Widget {

	function Widget_Adv336x280() {
		$widget_ops = array( 'classname' => 'adv336x280-widget'  );
		$control_ops = array( 'id_base' => 'adv336x280-widget' );
		parent::__construct( 'adv336x280-widget','Logger - Adv 336x280', $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		$defaults = array( 'title' => 'Adv 336x280' );
