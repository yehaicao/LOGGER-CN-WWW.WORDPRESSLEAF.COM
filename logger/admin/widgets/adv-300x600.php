<?php
/* Adv 300x600 */
add_action( 'widgets_init', 'widget_adv300x600_widget' );
function widget_adv300x600_widget() {
	register_widget( 'Widget_Adv300x600' );
}
class Widget_Adv300x600 extends WP_Widget {

	function Widget_Adv300x600() {
		$widget_ops = array( 'classname' => 'adv300x600-widget'  );
		$control_ops = array( 'id_base' => 'adv300x600-widget' );
		parent::__construct( 'adv300x600-widget','Logger - Adv 300x600', $widget_ops, $control_ops );
	}
