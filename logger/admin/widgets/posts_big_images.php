...
class Widget_post_big_images extends WP_Widget {
	...
	function Widget_post_big_images() {
		...
		parent::__construct( 'post_big_images-widget','Logger - posts big images', $widget_ops, $control_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		echo $before_widget;
			...
			<div class="widget_post_big_img">
				<?php Vpanel_post_big_images($posts_per_page,$orderby,$post_or_portfolio,$excerpt_title,$posts_excerpt,$display_meta,$display_review,$display,$category,$categories,$category_portfolio,$categories_portfolio);?>
			</div>
